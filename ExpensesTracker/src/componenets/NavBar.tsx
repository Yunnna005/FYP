export default function NavBar() {
    return <ul className="menu bg-sky-950 w-64 h-screen fixed top-0 left-0 p-4 gap-5">
        ...
        <li className="text-lg font-bold text-sky-700 hover:bg-sky-900"><a>Chat</a></li>
    </ul>;
}